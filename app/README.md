...
[Run a local development server](../CONTRIBUTING.md#developing-with-the-development-server) to develop against a local API with the following settings:

```shell
# .env
REACT_APP_API_URL=http://localhost:8000
REACT_APP_OIDC_LOGIN_URL=https://staging.arkhn.com/river/oidc/authenticate/
REACT_APP_OIDC_LOGOUT_URL=https://staging.arkhn.com/river/oidc/logout/
```

You need to register your local client on the identity provider. [Follow the guide](../CONTRIBUTING.md#registering-the-oauth-application)
