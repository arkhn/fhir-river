...
primary key to make reference from other branch in the hierarchy.
    ...
    from pyrog.api.serializers.import_export import ProjectSerializer
...
If the project database connection fails, the mapping is not recorded.
"""
...
class MappingSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        """Create Project and related models from the validated representation.
        ...
        project = Project.objects.create(**{**validated_data, "id": None})
        credential = Credential.objects.create(project=project, **credential_data)
        ...
        for resource_data in resources_data:
            ...
            resource = Resource.objects.create(primary_key_owner=owner, project=project, **{**resource_data, "id": None})
