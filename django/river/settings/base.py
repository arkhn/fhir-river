...
CORS_ALLOWED_ORIGINS = os.environ \
    .get('CORS_ALLOWED_ORIGINS', 'http://localhost:8000 http://localhost:3000') \
    .split(' ')
CSRF_TRUSTED_ORIGINS = os.environ \
    .get('CSRF_TRUSTED_ORIGINS', 'http://localhost:8000 http://localhost:3000') \
    .split(' ')
