...
import extractor.src.analyze.graphql as gql


@mock.patch("extractor.src.analyze.graphql.requests.post")
...
@mock.patch("extractor.src.analyze.graphql.run_graphql_query")
