...
public class AppProperties {
  ...
  private Boolean allow_inline_match_url_references = true;
  ...
  public Boolean getAllow_inline_match_url_references() {
    return allow_inline_match_url_references;
  }

  public void setAllow_inline_match_url_references(Boolean allow_inline_match_url_references) {
    this.allow_inline_match_url_references = allow_inline_match_url_references;
  }
